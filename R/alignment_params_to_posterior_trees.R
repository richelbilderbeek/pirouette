...
alignment_params_to_posterior_trees <- function(# nolint indeed a long name
  ...
  if (mcmc$store_every != -1) {
    ...
    # This can happen if bbt_out is read from a non-overwritten file,
    # generated by a previous experiment. In that case,
    ...
    if (length(trees) != expected_n_trees) {
      stop(
        ...
        ".trees filename: ", experiment$beast2_options$output_trees_filenames, " \n",
