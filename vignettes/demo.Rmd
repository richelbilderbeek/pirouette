...
```{r fig.width=7, fig.height=7}
babette::plot_densitree(out$trees, width = 2, consensus = true_phylogeny)
```
...
phangorn::densiTree(trees, consensus = true_phylogeny, col = colors, alpha = 3 / length(trees))

phangorn::densiTree(trees, consensus = true_phylogeny, col = colors, scaleX = TRUE, alpha = 1)
phangorn::densiTree(trees, consensus = true_phylogeny, col = colors, scaleX = TRUE, alpha = 3 / length(trees))
