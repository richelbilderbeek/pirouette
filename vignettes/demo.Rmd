...
testit::assert("tree" %in% names(errors))
testit::assert("true" %in% errors$tree)
testit::assert("twin" %in% errors$tree)

testit::assert("inference_model" %in% names(errors))
testit::assert("generative" %in% errors$inference_model)
testit::assert("best" %in% errors$inference_model)

testit::assert("inference_model_weight" %in% names(errors))

testit::assert("site_model" %in% names(errors))
testit::assert("JC69" %in% errors$site_model)

testit::assert("clock_model" %in% names(errors))
testit::assert("strict" %in% errors$clock_model)

testit::assert("tree_prior" %in% names(errors))
testit::assert("BD" %in% errors$tree_prior)

testit::assert("error" %in% names(errors))
```
