...
if (rappdirs::app_dir()$os != "win") {
  ...
  # Use the same BEAST2 input file, to assure the experiments do
  # operate on the same input
  # ?Unsure why this is needed?
  experiment_bd$beast2_options$input_filename <- 
    experiment_yule$beast2_options$input_filename
  experiment_bd$beast2_options$output_state_filename <-
    experiment_yule$beast2_options$output_state_filename  
  experiment_bd$inference_model$mcmc$tracelog$filename <-
    experiment_yule$inference_model$mcmc$tracelog$filename
  experiment_bd$inference_model$mcmc$treelog$filename <-
    experiment_yule$inference_model$mcmc$treelog$filename
