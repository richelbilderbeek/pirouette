...
```{r}
if (rappdirs::app_dir()$os != "win" && is_beast2_installed() && is_beast2_ns_pkg_installed() && 1 == 2) {
...
```{r}
if (rappdirs::app_dir()$os != "win" && is_beast2_installed() && is_beast2_ns_pkg_installed() && 1 == 2) {
  check_file_exists(pir_params$experiments[[1]]$beast2_options$output_log_filename)
