...
# UNIX users do both experiments
if (rappdirs::app_dir()$os != "win") {
  experiment_1$do_measure_evidence <- TRUE
...
```{r}
if (rappdirs::app_dir()$os != "win") {
  knitr::kable(read.csv(pir_params$evidence_filename))
}
```
...
```{r}
if (rappdirs::app_dir()$os != "win") {
  knitr::kable(read.csv(pir_params$twinning_params$twin_evidence_filename))
}
```
