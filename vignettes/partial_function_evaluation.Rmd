...
```{r}
alignment_params <- create_alignment_params(
  sim_true_alignment_function = sim_true_alignment_with_std_site_model,
  root_sequence = root_sequence  
)
true_alignment <- sim_true_alignment(
  true_phylogeny = true_phylogeny,
...
supplies this function as `get_sim_true_alignment_with_std_site_model_function`:
...
Or use `get_sim_twin_alignment_with_std_site_model_function` to do the 
