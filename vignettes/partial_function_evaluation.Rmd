...
ape::plot.phylo(twin_tree, main = "Twin phylogeny, default 'create_twin_tree'")
```
...
ape::plot.phylo(twin_tree, main = "Twin phylogeny, custom 'create_twin_tree'")
```
...
ape::plot.phylo(twin_tree, main = "Twin phylogeny, 'create_twin_tree' with my function")
```
...
# Show the twin tree
ape::plot.phylo(twin_tree, main = "Twin phylogeny, 'create_twin_tree' with partially evaluated function")
```
...
# Show the twin tree
ape::plot.phylo(twin_tree, main = "Twin phylogeny, 'create_twin_tree' with prefab partially evaluated BD function")
```
...
# Show the twin tree
ape::plot.phylo(twin_tree, main = "Twin phylogeny, 'create_twin_tree' with prefab partially evaluated Yule function")
```
...
# Show the twin tree
ape::plot.phylo(twin_tree, main = "Twin phylogeny, 'create_twin_tree' with prefab partially evaluated copy function")
```
